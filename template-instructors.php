...
$page_title = "اساتید و متخصصان آموزشگاه آنلاین فالنیک"; // عنوان برگه‌ای که در وردپرس می‌سازید
$page_desc = 'در این صفحه با اساتید، مجریان و متخصصان برتر حوزه فناوری اطلاعات، شبکه و سخت‌افزار در آموزشگاه آنلاین فالنیک آشنا می‌شوید؛ مدرسانی باتجربه و فعال در پروژه‌های بزرگ سازمانی که دانش روز بازار کار را به صورت کاملاً کاربردی و سناریومحور به شما منتقل می‌کنند تا مسیر حرفه‌ای خود را با اطمینان بسازید.
';
?>
...
<main class="eduf-archive-main eduf-archive-instructor-main">
    <div class="eduf-container">
        ...
        <section class="eduf-bottom-content">
            ...
            <p>یادگیری علم آی‌تی زمانی اثربخش است که زیر نظر اساتید مجرب و باسابقه هدایت شود. اساتید فالنیک بر اساس معیارهای سختی انتخاب می‌شوند تا بهترین کیفیت آموزشی را به شما ارائه دهند:</p>
...
<ul>
  ...
  <li><strong>انتقال مفاهیم به زبان ساده:</strong> یکی از مهم‌ترین ویژگی‌های مدرسان فالنیک، توانایی ساده‌سازی مفاهیم پیچیده و سنگین دیتاسنتر و شبکه برای دانشجویان است.</li>
