...
function evented_options_schema()
{
	...
	$schema = array(
		'general' => array(
			...
			'fields' => array(
				'site_tagline_fa'   => array('label' => 'شعار کوتاه (زیر لوگو در فوتر)', 'type' => 'textarea', 'default' => 'شمیم آشنا؛ مرجع آموزش مهارت‌های زندگی، خانواده، سواد رسانه و معارف — دوره، مقاله، پادکست و مسابقه در یک‌جا.'),
		...
		'urls' => array(
			'title'  => 'نشانی بخش‌ها (منو)',
			'icon'   => 'dashicons-admin-links',
			'fields' => array(
				'nav_url_articles'  => array('label' => 'مقالات',       'type' => 'text', 'default' => '', 'dir' => 'ltr', 'placeholder' => '/blogs/', 'desc' => 'خالی = تشخیص خودکار (برگهٔ نوشته‌ها یا /blogs/). مقدار نسبی مثل /blogs/ یا آدرس کامل.'),
				'nav_url_library'   => array('label' => 'کتابخانه',     'type' => 'text', 'default' => '', 'dir' => 'ltr', 'placeholder' => '/lib/'),
				'nav_url_gallery'   => array('label' => 'گالری',        'type' => 'text', 'default' => '', 'dir' => 'ltr', 'placeholder' => '/gallery/'),
				'nav_url_video'     => array('label' => 'ویدیو',        'type' => 'text', 'default' => '', 'dir' => 'ltr', 'placeholder' => '/videos/'),
				'nav_url_downloads' => array('label' => 'دانلودها',     'type' => 'text', 'default' => '', 'dir' => 'ltr', 'placeholder' => '/download/'),
				'nav_url_courses'   => array('label' => 'دوره‌ها',      'type' => 'text', 'default' => '', 'dir' => 'ltr', 'placeholder' => '/courses/'),
				'nav_url_podcast'   => array('label' => 'پادکست',       'type' => 'text', 'default' => '', 'dir' => 'ltr', 'placeholder' => '/podcast/'),
				'nav_url_ramadan'   => array('label' => 'ویژه رمضان',   'type' => 'text', 'default' => '', 'dir' => 'ltr', 'placeholder' => '/ramezan/'),
				'nav_url_contests'  => array('label' => 'مسابقات',      'type' => 'text', 'default' => '', 'dir' => 'ltr', 'placeholder' => '/match/'),
				'nav_url_about'     => array('label' => 'معرفی سایت',   'type' => 'text', 'default' => '', 'dir' => 'ltr', 'placeholder' => '/about-2/'),
				'nav_url_contact'   => array('label' => 'ارتباط با ما', 'type' => 'text', 'default' => '', 'dir' => 'ltr', 'placeholder' => '/contact/'),
				'nav_url_instructors' => array('label' => 'اساتید (فوتر)', 'type' => 'text', 'default' => '', 'dir' => 'ltr', 'placeholder' => '/#ee-instructors'),
			),
		),
		'social' => array(
		...
		'home' => array(
			...
			'fields' => array(
				...
				'quick_sub'       => array('label' => 'زیرعنوان دسترسی سریع', 'type' => 'text', 'default' => 'دوره‌ها، مقالات، پادکست، کتابخانه و مسابقات'),
				...
				'radio_title'     => array('label' => 'عنوان کارت رادیو (زیر آخرین مقالات)', 'type' => 'text', 'default' => 'رادیو شمیم'),
				'radio_sub'       => array('label' => 'توضیح کارت رادیو', 'type' => 'text', 'default' => 'پلیر دوره‌های صوتی؛ هر جا هستید گوش دهید'),
				'radio_url'       => array('label' => 'لینک کارت رادیو', 'type' => 'text', 'default' => '/player/', 'dir' => 'ltr'),
				'radio_badge'     => array('label' => 'برچسب کوچک رادیو (مثلاً «پخش زنده» — خالی = بدون برچسب)', 'type' => 'text', 'default' => 'سرویس صوتی'),
				'steps_title'     => array('label' => 'عنوان بخش ۳ گام', 'type' => 'text', 'default' => '۳ گام ساده تا شروع یادگیری'),
				'steps_sub'       => array('label' => 'زیرعنوان ۳ گام', 'type' => 'text', 'default' => 'در چند دقیقه و بدون پیچیدگی، به دوره‌های آموزشی سایت دسترسی پیدا کنید.'),
				'step1_title'     => array('label' => 'گام ۱ — عنوان', 'type' => 'text', 'default' => 'عضویت کاملاً رایگان'),
				'step1_text'      => array('label' => 'گام ۱ — توضیح', 'type' => 'text', 'default' => 'ثبت‌نام سریع تنها با یک شماره همراه، بدون نیاز به مدارک پیچیده'),
				'step2_title'     => array('label' => 'گام ۲ — عنوان', 'type' => 'text', 'default' => 'انتخاب دورهٔ دلخواه'),
				'step2_text'      => array('label' => 'گام ۲ — توضیح', 'type' => 'text', 'default' => 'دورهٔ متناسب با نیاز خود را از میان دسته‌بندی‌ها انتخاب و فعال کنید'),
