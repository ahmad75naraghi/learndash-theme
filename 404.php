	...
	<div class="ee-wrap">
		...
		<section class="ee-404">
			...
			<div class="ee-404-links">
				<a class="ee-btn ee-btn-primary" href="<?php echo esc_url(home_url('/')); ?>">
					<svg class="ee-ic" aria-hidden="true" focusable="false"><use href="#i-home"></use></svg> <?php esc_html_e('صفحهٔ اصلی', 'evented-edu'); ?>
				</a>
				<?php
				...
				if ($ee_courses_url) :
					...
					<a class="ee-btn ee-btn-ghost" href="<?php echo esc_url($ee_courses_url); ?>">
						<svg class="ee-ic" aria-hidden="true" focusable="false"><use href="#i-school"></use></svg> <?php esc_html_e('همهٔ دوره‌ها', 'evented-edu'); ?>
					</a>
				<?php endif; ?>
			</div>
		</section>
		...
		<?php if (!empty($ee_404_courses)) : ?>
			<section class="ee-404-more">
				<h2 class="ee-w-title"><svg class="ee-ic" aria-hidden="true" focusable="false"><use href="#i-new_releases"></use></svg> <?php esc_html_e('شاید این دوره‌ها برایتان مفید باشد', 'evented-edu'); ?></h2>
				<?php
