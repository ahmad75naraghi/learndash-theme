...
<aside class="sidebar">
    ...
    <nav class="nav-menu">
        <a href="/panel/my-courses" class="nav-item<?= $current === 'my-courses' ? ' active' : ''; ?>">
        ...
        <a href="/panel/certificates" class="nav-item<?= $current === 'certificates' ? ' active' : ''; ?>">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <a href="/panel/wishlist" class="nav-item<?= $current === 'wishlist' ? ' active' : ''; ?>">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <a href="/panel/payments" class="nav-item<?= $current === 'payments' ? ' active' : ''; ?>">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <a href="/panel/profile" class="nav-item<?= $current === 'profile' ? ' active' : ''; ?>">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <a href="/panel/settings" class="nav-item<?= $current === 'settings' ? ' active' : ''; ?>">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
